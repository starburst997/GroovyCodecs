...
{
    internal class NewMDCT
    {

        private static readonly float[][] win =
        {
            new[]
            {
            ...
            new[]
            {
                1.316524975873958e-01f,
                4.142135623730950e-01f,
                7.673269879789602e-01f,
                1.091308501069271e+00f,
        ...
        private static readonly float[] ca = win[Encoder.SHORT_TYPE];

        private static readonly float[] cs = win[Encoder.SHORT_TYPE];

        private static readonly float[] cx = win[Encoder.SHORT_TYPE];

        private static readonly float[] enwindow =
        {
            ...
            9.9182e-05f * 0.740951125354959f / 2.384e-06f,
            ...
            9.063471690191471e-01f,
            1.960342806591213e-01f,
            ...
            9.6321e-05f * 0.773010453362737f / 2.384e-06f,
            ...
            8.206787908286602e-01f,
            3.901806440322567e-01f,
            ...
            9.3460e-05f * 0.803207531480645f / 2.384e-06f,
            ...
            7.416505462720353e-01f,
            5.805693545089249e-01f,
            ...
            9.0599e-05f * 0.831469612302545f / 2.384e-06f,
            ...
            6.681786379192989e-01f,
            7.653668647301797e-01f,
            ...
            8.7261e-05f * 0.857728610000272f / 2.384e-06f,
            ...
            5.993769336819237e-01f,
            9.427934736519954e-01f,
            ...
            8.3923e-05f * 0.881921264348355f / 2.384e-06f,
            ...
            5.345111359507916e-01f,
            1.111140466039205e+00f,
            ...
            8.0585e-05f * 0.903989293123443f / 2.384e-06f,
            ...
            4.729647758913199e-01f,
            1.268786568327291e+00f,
            ...
            7.3433e-05f * 0.941544065183021f / 2.384e-06f,
            ...
            3.578057213145241e-01f,
            1.546020906725474e+00f,
            ...
            7.0095e-05f * 0.956940335732209f / 2.384e-06f,
            ...
            3.033466836073424e-01f,
            1.662939224605090e+00f,
            ...
            6.6280e-05f * 0.970031253194544f / 2.384e-06f,
            ...
            2.504869601913055e-01f,
            1.763842528696710e+00f,
            ...
            6.2943e-05f * 0.98078528040323f / 2.384e-06f,
            ...
            1.989123673796580e-01f,
            1.847759065022573e+00f,
            ...
            5.9605e-05f * 0.989176509964781f / 2.384e-06f,
            ...
            1.483359875383474e-01f,
            1.913880671464418e+00f,
            ...
            9.849140335716425e-02f,
            1.961570560806461e+00f,
            ...
            4.912684976946725e-02f,
            1.990369453344394e+00f,
            ...
            3.0526638e-02f / 2.384e-06f,
            4.638195e-03f / 2.384e-06f,
            7.47204e-04f / 2.384e-06f,
            4.9591e-05f / 2.384e-06f,
            4.756451e-03f / 2.384e-06f,
            2.1458e-05f / 2.384e-06f,
            -6.9618e-05f / 2.384e-06f
        };

        private const int NL = 36;

        private const int NS = 12;
        ...
        private static readonly float[] tantab_l = win[Encoder.SHORT_TYPE];

        private void window_subband(float[] x1, int x1Pos, float[] a)
        {
            var wp = 10;
        ...
        private void mdct_short(float[] inout, int inoutPos)
        {
            for (var l = 0; l < 3; l++)
            {
                ...
                ts1 = ts0 + tc0;
                ts2 = -ts0 + tc0;
                tc0 = (inout[inoutPos + 1 * 3] * win[Encoder.SHORT_TYPE][1] - inout[inoutPos + 4 * 3]) *
                      2.069978111953089e-11f;
                ts0 = (inout[inoutPos + 4 * 3] * win[Encoder.SHORT_TYPE][1] + inout[inoutPos + 1 * 3]) *
                      2.069978111953089e-11f;
        ...
        internal void mdct_long(float[] @out, int outPos, float[] @in)
        {
            float ct, st;
            {
