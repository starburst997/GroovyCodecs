...
namespace GroovyCodecs.Mp3.Mp3
{
    internal class Encoder
    {
        ...
        ///     FFT sizes
        /// </summary>
        internal const int BLKSIZE = 1024;

        internal const int BLKSIZE_s = 256;

        /// <summary>
        ///     parition bands bands
        /// </summary>
        internal const int CBANDS = 64;

        /// <summary>
        ///     Most decoders, including the one we use, have a delay of 528 samples.
        /// </summary>
        internal const int DECDELAY = 528;
        ...
        /// </summary>
        internal const int ENCDELAY = 576;

        internal static readonly int FFTOFFSET = 224 + MDCTDELAY;

        internal static readonly int HBLKSIZE = BLKSIZE / 2 + 1;

        internal static readonly int HBLKSIZE_s = BLKSIZE_s / 2 + 1;
        ...
        ///         18 th window:   [544..1055]          (1056)
        ///         MPEG1:            36 th window:   [1120..1631]         (1632)
        ...
        /// </summary>
        internal const int MDCTDELAY = 48;

        internal const int MPG_MD_LR_I = 1;
        ...
        ///     </PRE>
        /// </summary>
        internal const int MPG_MD_LR_LR = 0;

        internal const int MPG_MD_MS_I = 3;

        internal const int MPG_MD_MS_LR = 2;

        internal const int NORM_TYPE = 0;
        ...
        /// </summary>
        internal const int POSTDELAY = 1152;

        internal const int PSFB12 = 6;

        internal const int PSFB21 = 6;
        ...
        /// </summary>
        internal const int SBMAX_l = 22;

        internal const int SBMAX_s = 13;

        /// <summary>
        ///     number of critical bands/scale factor bands where masking is computed
        /// </summary>
        internal const int SBPSY_l = 21;

        internal const int SBPSY_s = 12;

        internal const int SHORT_TYPE = 2;

        internal const int START_TYPE = 1;

        internal const int STOP_TYPE = 3;

        internal BitStream bs;

        private readonly NewMDCT newMDCT = new NewMDCT();
