...
namespace GroovyCodecs.Mp3.Mpg
{
    internal class DCT64
    {
        ...
        internal virtual TabInit Modules
        {
            set => tabInit = value;
        }

        private void dct64_1(
            float[] out0,
            int out0Pos,
            float[] out1,
            int out1Pos,
         ...
         */
        internal virtual void dct64(float[] a, int aPos, float[] b, int bPos, float[] c, int cPos)
        {
            var bufs = new float[0x40];
